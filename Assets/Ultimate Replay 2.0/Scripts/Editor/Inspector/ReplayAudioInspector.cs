...
#pragma warning restore 0414
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Display fields
            bool changed = DisplayMultiEditableToggleField("Replay Pitch", "Record pitch value", ref pitch);
            changed |= DisplayMultiEditableToggleField("Replay Volume", "Record volume value", ref volume);
            changed |= DisplayMultiEditableToggleField("Replay Stereo Pan", "Record stereo pan value", ref stereoPan);
            changed |= DisplayMultiEditableToggleField("Replay Spatial Blend", "Record spatial blend value", ref spatialBlend);
            changed |= DisplayMultiEditableToggleField("Replay Reverb Zone Mix", "Record reverb zone mix value", ref reverbZoneMix);
            changed |= DisplayMultiEditableToggleField("Interpolate", "Interpolate the timesample value of the audio source", ref interpolate);
