...
public class OVRSkeleton : MonoBehaviour {
    ...
    private bool ShouldInitialize() {
        ...
        if (_skeletonType == SkeletonType.None) { return false; }
    ...
    protected virtual void InitializeBones() {
        ...
        for (int i = 0; i < _bones.Count; ++i) {
            ...
            else { _bones[i].Transform.SetParent(_bones[_bones[i].ParentBoneIndex].Transform, false); }
        }
    }
